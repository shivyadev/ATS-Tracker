    ...
    <div className="mt-2 p-2 pr-4">
      <div className="mt-2 flex justify-between">
        <span className="flex gap-2 items-center justify-center">
          <h2>Email </h2>
          {searchAbility["emails"] !== undefined ? (
        ...
        <span className="">
          {searchAbility["emails"] !== undefined ? searchAbility["emails"] : ""}
        </span>
      </div>
      <div className="mt-2 flex justify-between gap-4">
        <span className="flex gap-2 items-center justify-center">
          <h2>Contact Details </h2>
          {searchAbility["phones"] !== undefined ? (
            <Check className="bg-green-500 rounded-full text-white size-3" />
          ) : (
            <X className="bg-red-500 rounded-full text-white size-3" />
          )}
        ...
        <span className="">
          {searchAbility["phones"] !== undefined ? searchAbility["phones"] : ""}
        </span>
      </div>
